...
X | назви змінних кольорів

X | добавити плавні переходи на ховери

X | добавити тіні чи скейли коли 

X | кнопки пагінації все одно активні, навіть якщо сторінок далі вже більше немає
...
X | якщо не має постів то футер вилітає з орбіт, покарати його і поставити на місце

X | вирізати app-ку blog
