...
900 | виправити і переробити візуал деталів поста/1

X | додати плейсхолдери заміни для профілю (фото, біо, свої соцмережі)

75/25 | рефакторинг файлів і структури проєкту
...
X | забрати костиль з супер юзером (? | що за конфлікт?)

X | переробити консоль логи, або на щось краще, або просто зменшити їх кількість
...
X | на телефоні кнопки в хедері не ок стоять

X | відступи на телефоні на стр постів завеликі

X | у хедера інші точки перелому ніж в мейні (не критично, але)

X | відступи на телефоні на стр постів завеликі

X | зробити щоб після створення чи редагування поста чи кудись перекидало чи щось писало, бо не всюди зараз є
