...
винести серіалізатори в окрему папку і розбити по файлах

розбити вюхи по різних файлах і винести в папку

розбити стилі цсс на різні файли

розбити джс на модулі, зробити рефакторинг, змінити принцип виклику функцій під час відкриття певної сторінки

в креейт пост скрипт прямо запихнутий у верстку

забрати костиль з супер юзером

переробити консоль логи, або на щось краще, або просто зменшити їх ксть

якщо подивитись то стилі тягнуться просто з мільярду якихось файлів онлайн, чи дійсно всі актуальні підключені нам потрібні?

дефолтну джанго адмін манель варто все ж краще розписувати на всякий випадок + для дебагу


у хедера інші точки перелому ніж в мейні (не критично, але)

на телефоні кнопки в хедері не ок стоять

відступи на телефоні на стр постів завеликі

кольори не всюди змінні юзають

зробити щоб після створення чи редагування поста чи кудись перекидало чи щось писало, бо не всюди зараз є