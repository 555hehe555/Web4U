...
плейсхолдер на головну сторінку постів, на випадок якщо постів немає, щось типу "тут може бути ваший пост"

фавікон і іконка вкладки різні

кнопка "війти" в нижній навігації, "реєстрація", свагер

змінити плейсхолдер картинки в пості і додати в аватар профілю

функціонал видалення поста
